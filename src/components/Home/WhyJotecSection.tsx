    ...
    <section className="py-20 bg-emdad-navy">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2
            className={`text-xl sm:text-2xl md:text-3xl font-bold text-emdad-gold mb-12 md:mb-16 text-center animate-fade-in-up leading-tight ${
              language === 'ar'
                ? "font-['Cairo','Tajawal','GE_SS_Unique','DIN_Next_Arabic',sans-serif]"
                : ''
            }`}
          >
            {t('whyEmdad.title')}
                  ...
                  <div className="flex-1">
                    <h3
                      className={`text-lg sm:text-xl md:text-2xl font-semibold text-white mb-3 ${
                        language === 'ar'
                          ? "font-['Cairo','Tajawal','GE_SS_Unique','DIN_Next_Arabic',sans-serif] text-right"
                          : 'text-left'
                      }`}
                    >
                      {feature.title}
